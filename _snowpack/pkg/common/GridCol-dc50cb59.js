...
var backgroundColors = ['blue-ice', 'blue-pale', 'green-mint', 'grey-cloud', 'sand', 'grey-warm', 'orange-salmon', 'red', 'blue-sky', 'white'];
...
GridRow.propTypes = {
  ...
  background: propTypes.oneOf(['blue-ice', 'blue-pale', 'green-mint', 'grey-cloud', 'sand', 'grey-warm', 'orange-salmon', 'red', 'blue-sky', 'white']),
